          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.5, delay: 0.2 }} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div><p className="text-sm text-slate-400">Email</p><a href="mailto:baloglanovizzet@gmail.com" className="text-white hover:text-blue-400 transition-colors">baloglanovizzet@gmail.com</a></div>
              </div>
              <div className="flex items-center gap-4">
